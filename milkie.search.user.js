...
setTimeout(function() {
  ...
  var music_query = `${title_parse[1].replaceAll('_', ' ')} ${title_parse[2].replaceAll('_', ' ')}`
  var ops_search_url = `https://orpheus.network/torrents.php?searchstr=${query}`;
  ...
  var red_search_url = `https://redacted.ch/torrents.php?searchstr=${query}`;
